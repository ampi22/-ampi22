...
public class ChocolateBagsTest {
    ...
    @CsvSource({ "1,1,5,0", "1,1,6,1", "1,1,7,-1", "1,1,8,-1", "1,1,4,-1" })
    ...
    @ParameterizedTest(name = "small={0}, big={1}, total={2}, result={3}")
    @CsvSource({ "4,0,10,-1", "4,1,10,-1", "5,2,10,0", "5,3,10,0", "1,4,15,0" })
    ...
    @CsvSource({
        ...
        "0,3,12,-1", "1,3,12,-1", "2,3,12,2", "3,3,12,2", "3,2,14,-1", "5,2,14,4"})
    ...
    @ParameterizedTest(name = "small={0}, big={1}, total={2}, result={3}")
    @CsvSource({ "4,2,3,3", "3,2,3,3", "2,2,3,-1", "1,2,3,-1" , "0,1,1,-1", "3,1,3,3" })
